...
DAY_LOW_TIDE = Tide(
    feet_height=LOW_TIDE_HEIGHT,
    tide_type="Low Tide",
    tide_time=DAY_TIDE_TIME
)
NIGHT_LOW_TIDE = Tide(
    feet_height=LOW_TIDE_HEIGHT,
    tide_type="Low Tide",
    tide_time=NIGHT_TIDE_TIME
)
DAY_HIGH_TIDE = Tide(
    feet_height=HIGH_TIDE_HEIGHT,
    tide_type="High Tide",
    tide_time=DAY_TIDE_TIME
)
NIGHT_HIGH_TIDE = Tide(
    feet_height=HIGH_TIDE_HEIGHT,
    tide_type="High Tide",
    tide_time=NIGHT_TIDE_TIME
)
...
def test_get_daylight_low_tides():
...
def test_get_day_forecast_soups():
